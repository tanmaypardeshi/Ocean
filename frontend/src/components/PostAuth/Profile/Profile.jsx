...
import {
	Grid, Typography, Card, CardHeader, IconButton, Avatar, CardContent,
	CardActions, CardActionArea, Hidden, Button, Tab, Tabs, Paper, makeStyles, LinearProgress
	...
	return (
		<>
			<Card className={classes.root}>
				...
				<Edit user={user} toggle={handleEdit} edit={edit} />
				<CardHeader
					avatar={
